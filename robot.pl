...
% Link to video: https://1drv.ms/v/s!AhhpJUrLdLoUhIlQ4YG9M4osNLX2NA?e=6ZkCYN
...
% Costs of each node
cost(open, 1).
cost(closed, 1). % 3 to open plus 1 to move
cost(locked, 1).% 2 to unlock plus 3 to open plus 1 to move
